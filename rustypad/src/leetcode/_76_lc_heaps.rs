...
impl Solution {
    ...
    pub fn min_stone_sum(piles: Vec<i32>, k: i32) -> i32 {
        let mut hq: BinaryHeap<i32> = piles.into_iter().map(|x| x as i32).collect();
        let mut k = k;
        while k > 0 {
    ...
    pub fn top_k_frequent(nums: Vec<i32>, k: i32) -> Vec<i32> {
        ...
        let mut hq: BinaryHeap<(usize, i32)> = freq.into_iter()
            .map(|(item, count)| (count, item)).collect();
    ...
    pub fn top_k_frequent_words(words: Vec<String>, k: i32) -> Vec<String> {
        ...
        let mut hq: BinaryHeap<FreqPair> = 
            freq.into_iter()
            .map(|(item, count)| FreqPair(count, item)).collect();
    ...
    pub fn k_closest(points: Vec<Vec<i32>>, k: i32) -> Vec<Vec<i32>> {
        ...
        let mut distances: BinaryHeap<(Reverse<Float>, i32, i32)> = 
            points
            .into_iter()
            .map(|point| {
