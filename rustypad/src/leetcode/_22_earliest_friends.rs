...
impl Solution {
    ...
    /// a is acquainted with a person b if a is friends with b, or a is a friend of someone acquainted with b.
    //
    // Return the earliest time for which every person became acquainted with every other person. If there is 
    // no such earliest time, return -1.
    //
    //
    // Example 1:
    // -----------
    // ```
    // let logs = vec![
    // vec![20190101,0,1],vec![20190104,3,4],vec![20190107,2,3],vec![20190211,1,5],
    // vec![20190224,2,4],vec![20190301,0,3],vec![20190312,1,2],vec![20190322,4,5]]; 
    // let n = 6;
    // assert_eq!(Solution::earliest_consecutives_friends(logs, n), 20190301);
    // ```
    // Explanation: 
    ...
    // -----------
    // ```
    // let logs = vec![vec![0,2,0],vec![1,0,1],vec![3,0,3],vec![4,1,2],vec![7,3,1]]; let n = 4;
    // assert_eq!(Solution::earliest_consecutives_friends(logs, n), 3);
    // ```
