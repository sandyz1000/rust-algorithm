...
impl<T: Clone, A> Clone for LRUCache<A> {
    fn clone(&self) -> Self {
        Self {
...
impl<T: fmt::Debug, A> fmt::Debug for LRUCache<A> {
...
mod test {
    ...
    fn items<T: Clone, A>(cache: &mut LRUCache<A>) -> Vec<T> {
