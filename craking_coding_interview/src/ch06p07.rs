...
// new generation be? (Assume that the odds of someone having a boy or a girl on any given pregnancy 
// is equal.) Solve this out logically and then write a computer simulation of it.